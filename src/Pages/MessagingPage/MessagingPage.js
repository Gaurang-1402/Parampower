  ...
  return (
    <div className='w-full bg-primary h-screen'>
      <div className='flex justify-center'>
        <div className='flex-1 bg-white p:2 sm:p-6 justify-between flex flex-col w-120 h-150'>
            ...
            <div className='relative flex items-center space-x-4'>
              ...
              <div className='flex flex-col leading-tight'>
                <div className='text-2xl mt-1 flex items-center'>
                  <span className='text-gray-700 mr-3'>Ana Bobo</span>
                </div>
                <span className='text-lg text-gray-600'>Nurse</span>
              </div>
            </div>
